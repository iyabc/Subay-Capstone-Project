<?php 
  ...
  if(isset($_COOKIE["student"]) && isset($_COOKIE["faci"]) || isset($_COOKIE["User"])){
  ...
  if(isset($_COOKIE["User"]) && isset($_COOKIE["student"])){
...
<head>
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      <!-- login -->
  <form action="studdata.php" method="post">
    <h2>
      <?php
        echo "EDIT " 
        ?>
        <i><b><font color="#45958c">
      <?php 
        echo $_COOKIE["student"] . "'s";
        ?>
        </i></b></font>
      <?php 
        echo " DATA"; 
    ...
    <div class="form-group">
      <!-- hours -->
      <input type="number" min="0" max="999" name="hours" class="form-control" placeholder="Required Hour/s" required>
    </div>
    <!-- section -->
    <div class="form-group">
...
<!-- FETCH DATA!!! -->
   ...
   if($num == 1){
    ...
    ?>
    <table style="width:100%" border="2%" color="black">
          <tr>
            <th>Username</th>
            <th>Hour/s</th>
            <th>Section</th>
...
<!-- END OF FETCH -->
    <br>
    <br>
  <button type="submit" class="btn btn-xl btn-dark" name="edit">Edit</button>
  </form>
  <br>
  <br>
  ...
  <section class="content-section bg-dark">
   <div class="container text-center">
      <div class="row">
       ...
       <a class="btn btn-primary btn-xl" href="choosestudent.php">CHANGE/NEXT STUDENT</a>
       <br>
       <br> 
